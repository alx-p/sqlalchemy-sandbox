from sqlalchemy import Column, Integer, Text, String, Float, Numeric, Date, Time, Boolean, DateTime, ForeignKey, UniqueConstraint, Index, CheckConstraint, DateTime, Interval, ARRAY, Enum, UniqueConstraint, PrimaryKeyConstraint, Sequence, ForeignKeyConstraint
...
class Route(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['airplane_code'], ['airplanes_data.airplane_code'], name="routes_airplane_code_fkey"),
        ForeignKeyConstraint(['arrival_airport'], ['airports_data.airport_code'], name="routes_arrival_airport_fkey"),
        ForeignKeyConstraint(['departure_airport'], ['airports_data.airport_code'], name="routes_departure_airport_fkey"),
        #'comment': 'Routes',
        #'schema': 'bookings',
    )
